...
public class MainWindow
{
    ...
    private void initTabbedPane()
    {
        tabbedPane.addChangeListener(arg0 ->
        {
            ...
            {
                ((TabbedOnChangeListener) component).focusChanged(attendeesTab);
            }
        });
    }
    ...
    private JButton saveMenu()
    {
        return new JButton(new AbstractAction("Speichern")
        {
            ...
            {
                CSVUtils.writeToCsv(attendeesTab.getEntries(), new File(Config.getInstance().getAttendeesCsvFile()));
    ...
    private JButton loadMenu()
    {
        return new JButton(new AbstractAction("Laden")
        {
            ...
            public void actionPerformed(final ActionEvent e)
            {
                attendeesTab.loadEntriesFromCsv();
            }
